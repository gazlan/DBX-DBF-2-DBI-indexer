/* ******************************************************************** **
** @@ DBX DBF-2-DBI2 indexer (with dups)
** @  Copyrt :
** @  Author :
** @  Modify :
** @  Update :
...
** @  Modify :
** @  Update :
** @  Notes  : Hash160 compare function
** ******************************************************************** */
...
static void ForEach(const char* const pszFilename)
{
   ...
   _makepath( pszIdxName, pszDrive,pszDir,pszFName,"dbi2");
...
{
   const char  pszCopyright[] = "-*-   DBF-2-DBI2  1.0   *   Copyright (c) Gazlan, 2015   -*-";
   const char  pszDescript [] = "DBX DBF-2-DBI2 indexer (with dups)";
   const char  pszE_Mail   [] = "complains_n_suggestions direct to gazlan@yandex.ru";

   printf("%s\n\n",pszCopyright);
   printf("%s\n\n",pszDescript);
   printf("Usage: dbf2dbi2.com wildcards\n\n");
   printf("%s\n",pszE_Mail);
}
